...
def bank_filtering(df):
    ...
    # find banks whose total assets are more than 10 billion in at least one quarter from 2001 to 2024/9/30
    df1 = df[df['UBPR2170'] > 10000000]
    # find banks whose total deposits are more than 1 million in at least one quarter from 2001 to 2024/9/30
