...
def merge_bank_macro_datasets(bank_data, macro_data):
    
    """
    Combines two data sources: Bank panel data and macroeconomic indicators.
    Prepares the sample: 
    - creates lagged response variable
    - excludes data for the year 2024 where macroeconomic data is unavailable
    ...
    # Remove the data for the year 2024 as there is no available macroeconomic data for that year
    merged_df = merged_df[merged_df['Report Date']<='2024-12-31']
